            ...
            <div class="p-1 p-md-4 rounded-2 shadow-sm register-container">
                ...
                <div class="row m-0 justify-content-center align-items-center gap-md-4">
                    <div class="col-lg-5 col-md-6">
                        ...
                        <form method="POST" action="{{ route('en.password.email') }}" class="p-5 rounded-2 w-100">
                            <!-- Session Status -->
                            ...
                            <button type="submit" class="bg-main rounded-2 py-1 py-md-2 text-white outline-0 black w-100 my-3">Email Password Reset Link</button>
