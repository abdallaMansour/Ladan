    ...
    <section class="update-sec rounded-2">
        <div class="py-3 px-2 p-md-5 shadow-sm ">
            ...
            {{-- <form>
                ...
                <div class="mb-3">
                    <label for="exampleInputPassword1" class="form-label text-dark">كلمة المرور القديمة</label>
                    <input type="password" class="form-control" id="exampleInputPassword1">
                </div>

                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label  text-dark">كلمة المرور الجديدة</label>
                    <input type="password" class="form-control" id="exampleInputEmail1">
                </div>

                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label  text-dark">تأكيد كلمة المرور</label>
                    <input type="password" class="form-control" id="exampleInputEmail1">
                </div>
